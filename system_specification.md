...
- LA/EU rows have been inserted with rollbackable batch stamps: LA batch `LABO-20260515192608` has 3,637 rows and EU batch `EUBO-20260515192623` has 1,748 rows. Rollback remains scoped to the matching `import_batch_id` in `system_log`.
