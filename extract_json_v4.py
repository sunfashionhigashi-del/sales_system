...
try:
    ...
    for idx, row in df_order.iterrows():
        ...
        package_info = prod_map.get(vlook_id, {"qty": 0, "unit": ""})
        ...
        record = {
            ...
            "qty": qty,
            "unit": unit,
            "package_qty": package_info["qty"],
            "package_unit": package_info["unit"],
            "sales_currency": "JPY",
