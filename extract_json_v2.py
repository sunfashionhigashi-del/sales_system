...
try:
    ...
    try:
        ...
        # A: Invoice番号, B: 出荷日
        # Find exactly which columns map to A and B. Often header is complicated, let's just use index.
        invoice_date_map = {}
        # Assuming typical setup, we iterate and try to grab column 0 and column 1
        ...
        print("Warning: could not read 利益集計 properly:", e)
        invoice_date_map = {}
